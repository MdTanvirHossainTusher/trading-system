...
FROM eclipse-temurin:17-jre-alpine AS notification
WORKDIR /app
...
FROM eclipse-temurin:17-jre-alpine AS trade-execution
WORKDIR /app
...
FROM eclipse-temurin:17-jre-alpine AS signal-ingestion
WORKDIR /app
